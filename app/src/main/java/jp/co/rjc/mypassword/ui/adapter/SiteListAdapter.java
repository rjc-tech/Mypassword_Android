 ...
 * サイトリスト作成用のアダプターです。
 */
public class SiteListAdapter extends CursorAdapter implements MypasswordDatabase.SiteColumns, MypasswordDatabase.BaseColumns {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (cursor.moveToPosition(position)) {
            ...
            holder.mCassetteName.setText(cursor.getString(cursor.getColumnIndex(SITE_NAME)));
        }
        return view;
    }
