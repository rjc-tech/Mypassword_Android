		...
		if (SiteDetailActivity.SITE_EDIT_STATUS_UNREGISTERED == mEditStatus) {
			...
			mEditCompleteBtn.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View v) {
					...
					if (result > 0) {
						Toast.makeText(getActivity(), getResources().getString(R.string.toast_success_create), Toast.LENGTH_SHORT).show();
					}
					goSiteList();
				}
			});
			...
			mEditCompleteBtn.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View v) {
					...
					if (result > 0) {
						Toast.makeText(getActivity(), getResources().getString(R.string.toast_success_update), Toast.LENGTH_SHORT).show();
					}
					goSiteList();
				}
			});
		...
		if (c.moveToFirst()) {
			...
			mCopyIdBtn.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View v) {
					...
					Toast.makeText(getActivity(), getResources().getString(R.string.toast_copy_clipboard_id), Toast.LENGTH_SHORT).show();
				}
			});
			...
			mCopyPassBtn.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View v) {
					...
					ClipboardManager cm = (ClipboardManager) getActivity().getSystemService(CLIPBOARD_SERVICE);
					cm.setPrimaryClip(cd);
					Toast.makeText(getActivity(), getResources().getString(R.string.toast_copy_clipboard_pass), Toast.LENGTH_SHORT).show();
				}
			});
