...
public class SiteDetailActivity extends AppCompatActivity {
	 ...
	 * サイト削除メニューボタン
	 */
	public MenuItem mDeleteSiteBtn;
					...
					new AlertDialog.Builder(SiteDetailActivity.this)
							...
							.setPositiveButton(R.string.dialog_label_ok, new DialogInterface.OnClickListener() {
								...
								public void onClick(DialogInterface dialog, int which) {
									DatabaseHelper.delete(new DatabaseHelper(getApplicationContext()).getWritableDatabase(), getIntent().getIntExtra(Globals.INTENT_KEY_SITE_ID, -1));
